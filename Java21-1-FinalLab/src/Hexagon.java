...
public class Hexagon extends Polygon{
	...
	public Hexagon() {
		Point[] pt = {new Point(), new Point(), new Point(), new Point(), new Point(), new Point()};
		this.points = pt;
	}
	...
	public String toString() {
		return "Hexagon [points=" + Arrays.toString(points) + ", sides=" + Arrays.toString(sides) + ", diagonals="
