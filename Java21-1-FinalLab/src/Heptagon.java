...
// Polygon 추상클래스를 상속받은 칠각형 클래스
public class Heptagon extends Polygon{
	
	// 4.1 생성자
	public Heptagon(Point[] points) {
		super();
		this.points = points;
	}
	public Heptagon() {
		Point[] pt = {new Point(), new Point(), new Point(), new Point(), new Point(), new Point(), new Point()};
		this.points = pt;
	}
	...
	public String toString() {
		return "Heptagon [points=" + Arrays.toString(points) + ", sides=" + Arrays.toString(sides) + ", diagonals="
