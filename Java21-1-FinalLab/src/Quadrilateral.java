...
public class Quadrilateral extends Polygon{
	...
	public Quadrilateral() {
		Point[] pt = {new Point(), new Point(), new Point(), new Point()};
		this.points = pt;
	}
	...
	public String toString() {
		return "Quadrilateral [points=" + Arrays.toString(points) + ", sides=" + Arrays.toString(sides) + ", diagonals="
