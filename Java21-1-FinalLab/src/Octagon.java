...
public class Octagon extends Polygon{
	...
	public Octagon() {
		Point[] pt = {new Point(), new Point(), new Point(), new Point(), new Point(), new Point(), new Point(), new Point()};
		this.points = pt;
	}
	...
	public String toString() {
		return "Octagon [points=" + Arrays.toString(points) + ", sides=" + Arrays.toString(sides) + ", diagonals="
